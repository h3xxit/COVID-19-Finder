...
public class RegisterEmailOrPhone extends AppCompatDialogFragment {
    ...
    public RegisterEmailOrPhone(FragmentManager fragmentManager, UserAPI userAPI, Context context, Activity activity, TextView emailTextView, Button infectedBtn) {
                ...
                userAPI.sendConfirmationEmail(emailOrSmsDto).enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if(response.isSuccessful()){
                            ...
                            PasswordAndCode passwordAndCode = new PasswordAndCode(frgManager, userAPI, LoginRegisterContext, LoginRegisterActivity, emailTextView, infectedBtn, email);
